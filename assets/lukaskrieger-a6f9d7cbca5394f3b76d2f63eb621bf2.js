...
var t=Ember.HTMLBars.template({id:"SF/fTezX",block:'{"symbols":[],"statements":[[7,"h1"],[9],[0,"About"],[10],[0,"\\n\\n"],[7,"p"],[9],[0,"I grew up ."],[10],[0,"\\n\\n"],[7,"p"],[9],[0,"..."],[10],[0,"\\n\\n"],[7,"p"],[9],[0,"Drop me a line at "],[7,"a"],[11,"href","mailto:luakskrieger@gmail.com"],[11,"target","email"],[9],[0,"lukaskrieger@gmail.com"],[10],[10]],"hasEval":false}',meta:{moduleName:"lukaskrieger/templates/about.hbs"}})
...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("lukaskrieger/app").default.create({name:"lukaskrieger",version:"0.0.0+851d5c3f"})
